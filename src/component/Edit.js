...
useEffect(() => {
        ...
        setEmplyoeeName(localStorage.getItem('Emplyoee Name'));
...
const updateAPIData = (e) => {
  ...
  axios.put(`https://6260e8acf429c20deb977f95.mockapi.io/data/${id}`, {
    emplyoeeName,
    costCenter,
    expenseType
// }).then(() => {
...
handleShow1();
  ...
  <NavLink to='/Mywork'>
  <div class="col-auto">
  <a className="btn btn-warning m-1 text-white" id="save" type='submit' onClick={updateAPIData}><FiSave size={20} color="white" /> Save</a>
 </div>
  </NavLink>
 <NavLink to='/Mywork'>
 
 <div class="col-auto">
    <a className="btn btn-secondary m-1 text-white" id="cancel" href="dashboard.html">< TiCancel size={20} color="white"/>Cancel </a>
	   </div>
  </NavLink>
  </div>
  </div>
  ...
  {/* <label for="" className="form-label">Employee Name<span className="required">*</span></label>
  <Form.Control size="lg" type="text" placeholder="Large text" />
  <input type="text" name='employee' className="form-control" id="" value=" " Name onChange={(e)=>setEmplyoeeName(e.target.value)}/> 
  <input type="text" class="form-control" id="" value=""/> */}
  <Form>
  <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
    <Form.Label>Employee Name<span class="required">*</span></Form.Label>
     <Form.Control type="email"  name='employee' placeholder=" " value={emplyoeeName} onChange={(e)=>setEmplyoeeName(e.target.value)} /> 
 ...
 <Form>
  <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
    ...
    {/* <Form.Control type="email" name='cost' placeholder=" " value={costCenter} onChange={(e)=>setCostCenter(e.target.value)} /> */}
  ...
  <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
    ...
    {/* <Form.Control type="email" name='expense' placeholder=" " value={ expenseType} onChange={(e)=>setExpenseType(e.target.value)} /> */}
    <select  className="form-select" type="email" name='expense' placeholder=" " value={ expenseType} onChange={(e)=>setExpenseType(e.target.value)}  >
    <option selected disabled>Select</option>
...
<Modal show={show1} onHide={handleClose1}>
                      ...
                      <Modal.Footer>
                      <NavLink to='/Mywork'>   <a> <Button id="yes" onClick={handleClose1}>
                        Yes
                        </Button></a>
                        </NavLink>
